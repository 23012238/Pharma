...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <a class="navbar-brand" href="#">REDDY PHARMA</a>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-4">
        <img src="iOWraRyE0Dzz0HdvhOy1w3HP1gBCEjRE6D9M1HXH.jpeg" class="img-fluid" alt="Pharmacy Image">
      </div>
    </div>
  </div>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany. All rights reserved. BY S.L.NARASIMHA REDDY</p>
  </footer>
...
<body>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="AA.jpg" class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="BBB.jpeg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="CCC.jpeg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="DDDD.jpeg" class="card-img-top" alt="Product 3" width="200" height="200">
            <div class="card-body">
  ...
  <!-- Footer -->
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaCompany. All rights reserved. S.L.NARASIMHA REDDY</p>
  </footer>
